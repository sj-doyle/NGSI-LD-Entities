...
| <em>dateLastCalibration</em> | <em>TemporalProperty</em> | <em>Indicates the date/time at which date and time the machine was last calibrated (nominally in UTC).<br/><br/>Note this field was defined for use with NGSIv2 and is now deprecated. For new entities and applications replace with **lastCalibratedAt**</em> | <em>Deprecated</em> |
